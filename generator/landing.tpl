<div class="landing_container">
    ...
    <div class="landing_panel landing_panel-1">
        <div class="landing_wrapper" style="background: linear-gradient(0deg, rgba(8, 58, 166, 0.2) 0%, rgba(83, 171, 234, 0) 69.43%), url(../assets/images/landing/section-1-bg.jpg); background-blend-mode: multiply, normal;">
            ...
            <div class="landing_wrapper-floating">
                <img class="section-1-phone" src="../assets/images/landing/section-1-phone.png">
                <img class="section-1-phone-shadow" src="../assets/images/landing/section-1-phone-shadow.png">
            </div>
        </div>
    </div>
    ...
    <div class="landing_panel landing_panel-5">
        <div class="landing_wrapper" style="background: #0D2165;">
            <div class="landing_wrapper-bounding-box">
