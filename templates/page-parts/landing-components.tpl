...
<div class="element">
    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-save-bg.jpg);">
    ...
    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-scan-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-scan-icon.svg);"></span>
        <div class="title" style="color: #CFE3FE;">Scan to pay</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-insure-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-insure-icon.svg);"></span>
        <div class="title" style="color: #0D2165;">Insure</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-gcredits-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-gcredits-icon.svg);"></span>
        <div class="title" style="color: #2B3990;">GCredits</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-bank-transfer-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-bank-transfer-icon.svg);"></span>
        <div class="title" style="color: #D6F5FF;">Bank Transfer</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-loan-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-loan-icon.svg);"></span>
        <div class="title" style="color: #0B357B;">Loan</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-cash-in-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-cash-in-icon.svg);"></span>
        <div class="title" style="color: #2B3990;">Cash In</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-gforest-bg.jpg);">
        <span class="icon" style="background-image: url(./assets/images/services-card-gforest-icon.svg);"></span>
        <div class="title" style="color: #0A5363;">GForest</div>
    </div>

    <div class="landing_services-card" style="background-image: url(./assets/images/services-card-admit-bg.jpg);"></div>
    ...
    <div class="landing_services-card" style="background: #112C88;"></div>

    <div class="landing_services-card" style="background: #08153F;"></div>

    <div class="landing_services-card -bottom-left" style="background-image: url(./assets/images/services-card-invest-bg.jpg);">
        <div class="title" style="color: #D6F5FF;">Invest</div>
    </div>

    <div class="landing_services-card -bottom-left" style="background-image: url(./assets/images/services-card-send-bg.jpg);">
    ...
    <div class="landing_services-card -bottom-left -no-padding-bottom" style="background-image: url(./assets/images/services-card-finger-print-bg.jpg);">
        <div class="title" style="color: #C4DEFD;">We care about your security.</div>
    </div>

    <div class="landing_services-card -content-only" style="background: transparent;">
    ...
    <div class="landing_shop-item -watch" style="background: url(./assets/images/shop-item-watch.png) 24px/contain no-repeat,linear-gradient(254.99deg, #ffffff 15.71%, #dbd7e1 96.48%);">
        <div class="content">
    ...
    <div class="landing_shop-item -vase" style="background: url(./assets/images/shop-item-vase-img.jpg)center/contain no-repeat;">
        <div class="content">
    ...
    <div class="landing_shop-item -tote" style="background: url(./assets/images/shop-item-tote.png)center/contain no-repeat, linear-gradient(180deg, #EFEDF2 0%, rgba(239, 237, 242, 0) 100%);">
        <div class="content">
    ...
    <div class="landing_use-case-bubble -amount-received" style="background-image: url(./assets/images/use-case-bubble-amount-received-bg.jpg);">
